 ...
 */
final class Version20221214215907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE director (id INT AUTO_INCREMENT NOT NULL, name LONGTEXT NOT NULL, surname VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, director_id INT NOT NULL, name VARCHAR(255) NOT NULL, year LONGTEXT DEFAULT NULL, rating INT NOT NULL, main_cast LONGTEXT NOT NULL, synopsis LONGTEXT NOT NULL, code INT NOT NULL, INDEX IDX_1D5EF26F899FB366 (director_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
